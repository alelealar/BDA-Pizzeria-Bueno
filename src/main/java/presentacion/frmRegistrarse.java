...
public class frmRegistrarse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegistraeseLayout.setHorizontalGroup(
            ...
            .addComponent(btnRegistrarse, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
        );
        btnRegistraeseLayout.setVerticalGroup(
            btnRegistraeseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(btnRegistrarse, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        );
        ...
        panContenedorLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panContenedorLayout.createSequentialGroup()
                ...
                .addComponent(panFormulario, javax.swing.GroupLayout.PREFERRED_SIZE, 743, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18))
        );
    ...
    private void btnRegistrarseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarseMouseClicked
        if(!txtNombre.getText().trim().matches("^[A-Za-zñÑáéíóúÁÉÍÓÚ\\s]+$")){
            JOptionPane.showMessageDialog(this, "El nombre solo debe contener letras y espacios.", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtApellido.getText().trim().matches("^[A-Za-zñÑáéíóúÁÉÍÓÚ\\s]+$")){
            JOptionPane.showMessageDialog(this, "El/Los apellidos solo debe contener letras y espacios.", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(txaTelefonos.getText().trim().isBlank()){
            JOptionPane.showMessageDialog(this, "Se debe registrar al menos un telefono", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtCalle.getText().trim().matches("^[A-Za-zñÑáéíóúÁÉÍÓÚ0-9\\s]+$")){
            JOptionPane.showMessageDialog(this, "La calle solo debe contener letras, espacios y numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtNumero.getText().trim().matches("^[A-Za-z0-9\\s]+$")){
            JOptionPane.showMessageDialog(this, "El numero no debe contener caracteres especiales", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtColonia.getText().trim().matches("^[A-Za-zñÑáéíóúÁÉÍÓÚ0-9\\s.,-]+$")){
            JOptionPane.showMessageDialog(this, "La colonia solo debe contener letras, espacios y numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtCP.getText().trim().matches("^[0-9]{5}$")){
            JOptionPane.showMessageDialog(this, "El codigo postal solo debe contener 5 numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtDia.getText().trim().matches("^[0-9]{2}$")){
            JOptionPane.showMessageDialog(this, "El dia solo debe contener 2 numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtMes.getText().trim().matches("^[0-9]{2}$")){
            JOptionPane.showMessageDialog(this, "El mes solo debe contener 2 numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if(!txtAnio.getText().trim().matches("^[0-9]{4}$")){
            JOptionPane.showMessageDialog(this, "El año solo debe contener 2 numeros", "Datos Inválidos", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(!txtContraseña.getText().equals(txtConfirmacionContraseña.getText())){
            JOptionPane.showMessageDialog(this, "Las contraseñas no coinciden", "Fallo al confirmar contraseña", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try{
            ...
            ClienteDTO clienteCreado = new ClienteDTO(txtNombre.getText().trim(), txtApellido.getText().trim(), txtCalle.getText().trim(), txtNumero.getText().trim(), txtColonia.getText().trim(), txtCP.getText().trim(), dia, mes, anio);
    ...
    private void btnEliminarTelefonoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarTelefonoMouseClicked
        frmEliminarTelefono eliminarTelefono = new frmEliminarTelefono(telefonosTemp);

        eliminarTelefono.setLocationRelativeTo(this);

        eliminarTelefono.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
    ...
    eliminarTelefono.setVisible(true);
    ...
    public void agregarTelefonoALista(TelefonoDTO temp){
        this.telefonosTemp.add(temp);
        
        txaTelefonos.setText("");
        for(TelefonoDTO tel: telefonosTemp){
            txaTelefonos.append(tel.getEtiqueta()+": "+tel.getTelefono()+"\n");
        }
    }
    
    public void actualizarTXA(){
        txaTelefonos.setText("");
        for(TelefonoDTO tel: telefonosTemp){
            txaTelefonos.append(tel.getEtiqueta()+": "+tel.getTelefono()+"\n");
        }
